...
public class DragonStone extends Item {
    ...
    public DragonStone(Properties properties) {
        super(properties);
    }
    ...
    private void rightClickOnCertainBlockState(BlockState clickedBlock, ItemUseContext context, PlayerEntity playerEntity) {
        ...
        else if(playerIsNotOnFire && blocIsValidForResistance(clickedBlock)){
    ...
    private boolean blocIsValidForResistance(BlockState clickedBlock) {
